  ...
  return (
	<div className='overflow-hidden'>
        <div className="h-screen w-full relative bg-gradient-to-b from-black to-transparent">
            <img src={Background} alt="" className='w-full brightness-[0.3] absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transparent hidden md:block'/>
            ...
            <img src={UpperSmoke} className="md:w-[42vw] animate-[customSpin_60s_linear_reverse_infinite] z-20 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"/>
            <img src={Alien} alt="" className='w-[12vw] md:w-[12vw] z-20 absolute left-1/2 bottom-0 -translate-x-1/2 h-auto'/>
            <div className='font-semibold text-lg z-20 absolute right-0 bottom-1/4 animate-[customBounce_2s_ease-in-out_infinite] rotate-0 md:-rotate-90'>Scroll Down</div>
        </div>
    </div>
  )
}
